  ...
  list: [
    {
      ...
      img: [
        require('@/assets/images/00_product00.jpg'),
    ...
    },
    {
      ...
      content: '선없는 충전이 필요하세요?➰🔋얼리어답터 춘식에게 맡겨주세요',
      img: [
        require('@/assets/images/01_product00.jpg'),
        require('@/assets/images/01_product01.jpg'),
        require('@/assets/images/01_product02.jpg'),
    ...
    },
    {
      ...
      img: [
        require('@/assets/images/02_product00.jpg'),
        require('@/assets/images/02_product01.jpg'),
